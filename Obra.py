...
class ObraDetallada:
    ...
    def show_detalles(self):
        print(f"\nTítulo de la Obra: {self.titulo}\n"
            f"Nombre del Artista: {self.autor.nombre} \n"
            f"Nacionalidad del Artista: {self.autor.nacionalidad}\n"
            f"Fecha de nacimiento del Artista: {self.autor.nacimiento}\n"
            f"Fecha de muerte del Artista: {self.autor.muerte}\n"
